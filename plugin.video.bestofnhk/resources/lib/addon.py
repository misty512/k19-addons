...
class Addon:
    ...
    def add_item(self, queries, infolabels, contextmenu_items='', context_replace=False, img='',
                 fanart='', subtitle='', resolved=False, total_items=0, playlist=False, item_type='video', 
                 is_folder=False):
        '''
    ...
    def add_video_item(self, queries, infolabels, contextmenu_items='', context_replace=False,
                       img='', fanart='', subtitle='', resolved=False, total_items=0, playlist=False):
        '''
        ...
        '''
        self.add_item(queries, infolabels, contextmenu_items, context_replace, img, fanart, subtitle,
    ...
    def add_music_item(self, queries, infolabels, contextmenu_items='', context_replace=False,
        ...
        See :meth:`add_item` for full infomation
        '''
        self.add_item(queries, infolabels, contextmenu_items, img, context_replace, fanart, subtitle,
